  ...
  return (
    ...
    >
      <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
        ...
        <Field>
          <FieldDescription>
            Guest session data is initialized automatically and carried into the
            authenticated session by the backend contract when you sign in.
          </FieldDescription>
        </Field>
      </form>
    </AuthShell>
